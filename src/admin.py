...
class admin:
    def __init__(self,root,myuid,mypass):
        ...
        title = Label(self.frame1,text = "<<Admin Dashboard>>", font=("Oblique",18), bg="white").place(x=550,y=40)
    ...
    def checkuserid(self):
        uid=StringVar()
        connection1 = psycopg2.connect(host="localhost", user="postgres", password="root", database="inveMSys")
